...
public class SelleBay { 
	...
	public void eBay( ) throws IOException {
			...
			Reporter.log("eBay Selling page is Displayed", true);
			
			WebDriverWait wait = new WebDriverWait(driver, 20);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("i-srvy")));
			driver.findElement(By.id("i-srvy")).click();
			
			driver.findElement(By.id("_ch08")).click();
			
			
			TakesScreenshot ts = (TakesScreenshot)driver;
			File src = ts.getScreenshotAs(OutputType.FILE);
			File des = new File("D:\\Selenium\\eBayUs\\Screenshot\\SellingPage.png");
			Files.copy(src,des);
			...
			File des1 = new File("D:\\Selenium\\eBayUs\\Screenshot\\AfterScrolling.png");
